import { script } from './dom-helpers.js';
const BODY = document.body;
BODY.append(script(
    {
        src: 'https://assets.adobedtm.com/80673311e435/fa363ab0f5b6/launch-129bd6c73057-development.min.js',
        defer: true
    }
));
BODY.append(script(
    {
        src: 'https://hbsearch.senseforth.com/js/sf-searchLoader-newui.js',
        defer: true
    }
));
BODY.append(script(`    console.log('ss')
    var nv = nv || function() {
    ...
    var notify_visitors = notify_visitors || function() {
        var t = {
            ...
            on_load: !1,
            auth: {
                bid_e: "403942A121E35F041DDCED96762773B8",
                bid: "9049",
                t: "420"
            }
        };
        return t.data = {
            ...
            return t && t[2] ? decodeURIComponent(t[2].replace('', " ")) : ""
        }, t.init = function() {
